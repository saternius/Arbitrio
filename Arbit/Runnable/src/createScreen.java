...
public class createScreen implements KeyListener {
	Image bg = Images.createBg;
	Image arrowBtn = Images.arrow_btn;
	Image arrowBtnGlow = Images.arrow_btn_glow;
	Image saveBtnReg = Images.save_btn;
	Image saveBtnGlow = Images.save_btn_glow;
	Image loadBtnGlow = Images.load_glow;
	Image loadBtnReg = Images.load;
	Image genBtnReg = Images.generate_btn;
	Image genBtnGlow = Images.generate_btn_glow;
	Image newBtnReg = Images.new_btn;
	Image newBtnGlow = Images.new_btn_glow;
	Image postBtnReg = Images.post_it_btn;
	Image postBtnGlow = Images.post_it_btn_glow;
	Image exitBtnReg = Images.exit_btn;
	Image exitBtnGlow = Images.exit_btn_glow;
	Image toolbarDropShadow = Images.longDropShaddow;
	Image abilityIcon = Images.abilityIcon;
	Image abilityIconGlow =Images.abilityIconGlow;
	 ...
	 * Array(); --> needs
	 */
	public String[] var_names = new String[8];
	public String[] var_type = new String[8];
	public Object[] var_value = new Object[8];
